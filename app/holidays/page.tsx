        ...
        <div className="p-8 bg-gray-50 min-h-screen font-sans">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex justify-between items-start mb-6">
                    <div>
                        <h1 className="text-2xl font-bold text-green-900 tracking-tight">holidays</h1>
                        <p className="text-gray-500 text-sm mt-1">Manage holidays for your organization.</p>
                    </div>
                    {/* <button className="bg-[#114232] hover:bg-[#0a2a20] text-white px-4 py-2 rounded-md flex items-center gap-2 text-sm font-medium transition-colors shadow-sm">
                        <span className="text-lg">+</span> Add Holiday
                    </button> */}
                    <Button text="add Holiday" disabled={false} type="button"/>
                </div>
